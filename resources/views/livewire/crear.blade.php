            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-4">
                        ...
                        @error('edad') <span class="text-red-500 text-xs py-1">{{ $message }}</span> @enderror
                    </div>
                    <div class="mb-4">
                        <label for="grupo" class="block text-gray-700 text-sm font-bold mb-2">Grupo:</label>
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="grupo" wire:model="grupo">
                        @error('grupo') <span class="text-red-500 text-xs py-1">{{ $message }}</span> @enderror
                    </div>
